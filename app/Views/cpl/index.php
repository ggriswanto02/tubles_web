                    ...
                    <?php $no = 1; foreach ($cpl as $row): ?>
                      <tr>
                        ...
                        <td><button 
                                ...
                                data-bs-target="#modalEditCPL"
                                data-id="<?= $row['id']; ?>"
                                data-penyusun="<?= $row['id_penyusun']; ?>"
                                data-mk="<?= $row['id_matakuliah']; ?>"
                                data-cpl="<?= $row['cpl_prodi']; ?>"
                            >Edit</button>
                            <button 
                                class="btn btn-danger btn-sm"
                                data-bs-toggle="modal"
                                data-bs-target="#modalDeleteCPL"
                                data-href="<?= base_url('table/cpl/delete/' . $row['id']) ?>"
                            >Hapus</button>
                        </td>
