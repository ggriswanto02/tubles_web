            ...
            <div class="col-12">
                <div class="card mb-0">
                    <div class="card-header pb-0">
                        ...
                        <?php endif ?>
                        <a href="<?= site_url('table/nilai-mhs-pertemuan/export') ?>"
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card card-plain">
                                                    ...
                                                    <div class="card-body pb-3">
                                                        <form action="<?= base_url('table/nilai-mhs-pertemuan/new') ?>"
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Masukkan Rencana Pembelajaran" required>
                                                            </div>
                                                            <label>Nilai Kompetensi</label>
                                                            <div class="input-group mb-3">
                                                                <input type="text" class="form-control"
                                                                    name="nilai_kompetensi"
                                                                    placeholder="Masukkan Nilai Kompetensi" required>
                                                            </div>
                                                            <label>Status</label>
                                                            <div class="input-group mb-3">
