    ...
    <ul class="navbar-nav bg-gray-100">
      ...
      <li class="nav-item" id="tablesDropdown">
        ...
        <ul class="dropdown-menu bg-gray-100" aria-labelledby="tablesDropdown">
          <li><a class="dropdown-item" href="<?= base_url('rencana-pembelajaran') ?>">Rencana Pembelajaran</a></li>
          <li><a class="dropdown-item" href="<?= base_url('nilai-pertemuan-mahasiswa') ?>">Nilai Pertemuan</a></li>
          <li><a class="dropdown-item" href="<?= base_url('korelasi-cpl-cpmk') ?>">Korelasi CPL–CPMK</a></li>
          <li><a class="dropdown-item" href="<?= base_url('capaian-lulusan') ?>">Capaian lulusan</a></li>
        </ul>
      </li>
    </ul>
  </div>
